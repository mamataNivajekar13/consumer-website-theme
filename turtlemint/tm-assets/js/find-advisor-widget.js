const REDIRECT_CONFIG = [
    {
        ...
        "target": "https://www.turtlemint.com/insurance-advisor-near-me/?vertical=Life",
        "verticalName": "Life"
    },
    {
        "source": "https://*/car-insurance/*",
        "target": "https://www.turtlemint.com/insurance-advisor-near-me/?vertical=FW",
        "verticalName": "4 Wheeler"
    },
    {
        "source": "https://*/two-wheeler-insurance/*",
        "target": "https://www.turtlemint.com/insurance-advisor-near-me/?vertical=TW",
        "verticalName": "2 Wheeler"
    },
    {
        "source": "https://*/health-insurance/*",
        "target": "https://www.turtlemint.com/insurance-advisor-near-me/?vertical=Health",
        "verticalName": "Health"
    }
];
...
(function() {
    ...
    widget.innerHTML=`<img src="https://www.turtlemint.com/wp-content/uploads/advisor-widget.png" alt="Advisor wiget avatar"><p>Get Free Advice<span></span></p>`;
...
async function redirect(){
    ...
    let targetURL = "https://www.turtlemint.com/insurance-advisor-near-me/"
    try{
        // let response = await fetch('https://www.turtlemint.com/find-advisor-widget/redirect-config.json');
