...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <?php
            ...
            $title = ucwords($insurerVertical)." Critical Illness Plans | Turtlemint";

            $description = "Check the critical Illness plans offered by ".ucwords($insurerVertical)." Insurance online. Explore the plan benefits, starting premiums and coverage range on Turtlemint.";

            $keywords = strtolower($insurerVertical)." critical illness, critical illness insurance".strtolower($insurerVertical).", ".strtolower($insurer_display_name)." critical illness policy, ".strtolower($insurerVertical)." insurance critical illness plan, critical illness policy ".strtolower($insurerVertical).", critical illness ".strtolower($insurerVertical);
            ...
            $current_page_link = $term_page_link.'critical-illness/';
            ...
            $piece["itemListElement"] = [
                ...
                [
                    "@type" => "ListItem",
                    "position" => 3,
                    "name" => ucwords($insurerVertical." Insurance"),
                    "item" => $term_page_link
                ],
                [
                    "@type" => "ListItem",
                    "position" => 4,
                    "name" => ucwords($insurerVertical." Critical Illness Plans"),
        ...
        <script type="application/ld+json">
            {
                ...
                "@type": "WebPage",
                "name": "<?php echo $insurerVertical; ?> Critical Illness Plans",
                "speakable":
                {
    ...
    <body <?php body_class('tm-style-1'); ?>>
        ...
        <div class="wp-site-blocks">
            ...
            <?php echo do_shortcode('[tm_ic_nh_banner type="critical-illness"]'); ?>
            ...
            <section class="wp-block-group has-global-padding is-layout-constrained">
                <div class="wp-block-columns alignwide is-layout-flex ic-two-column">
                    <div class="wp-block-column is-layout-flow left-scrollable" style="flex-basis:65%">
                        <?php echo do_shortcode('[tm_ic_plans tag="critical-illness" limit="3"]'); ?>
