...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <?php
            ...
            $title = ucwords($insurerVertical)." Insurance Customer Care | Turtlemint";

            $description = "Check the ".ucwords($insurer_display_name." ".$vertical_name)." Insurance customer care details like Toll Free number & Email-id online. ";

            $keywords = strtolower($insurerVertical)." customer care, ".strtolower($insurerVertical)." insurance customer care, ".strtolower($insurerVertical)." customer care number, ".strtolower($insurerVertical)." insurance customer care number, ".strtolower($insurerVertical)." insurance customer care no, ".strtolower($insurerVertical)." customer care email id";
            ...
            $current_page_link = $term_page_link.'customer-care/';
            ...
            $piece["itemListElement"] = [
                ...
                [
                    "@type" => "ListItem",
                    "position" => 4,
                    "name" => ucwords($insurer_display_name." ".$vertical_name." Insurance Customer Care"),
        ...
        <script type="application/ld+json">
            {
                ...
                "@type": "WebPage",
                "name": "<?php echo $insurerVertical; ?> Insurance Customer Care",
                "speakable":
                {
    ...
    <body <?php body_class('tm-style-1'); ?>>
        ...
        <div class="wp-site-blocks">
            ...
            <?php echo do_shortcode('[tm_ic_nh_banner type="customer-care"]'); ?>
