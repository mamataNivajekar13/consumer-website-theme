...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <?php
            ...
            $title = ucwords($insurerVertical)." Insurance Claim Settlement Ratio (CSR) & Claim Process | Turtlemint";

            $description = "Check the claim settlement ratio for ".ucwords($insurerVertical)." Insurance provided by IRDAI, along with a claim process guide on Turtlemint";

            $keywords = strtolower($insurerVertical)." insurance claim settlement ratio, ".strtolower($insurerVertical)." claim settlement ratio, ".strtolower($insurerVertical)." reimbursement claim form, ".strtolower($insurerVertical)." claim, ".strtolower($insurerVertical)." insurance claim ratio, ".strtolower($insurerVertical)." claim ratio, how to claim ".strtolower($insurerVertical)." insurance";
            ...
            $current_page_link = $term_page_link.'claim-settlement/';
            ...
            $piece["itemListElement"] = [
                ...
                [
                    "@type" => "ListItem",
                    "position" => 4,
                    "name" => ucwords($insurer_display_name." ".$vertical_name." Insurance Claim Settlement Ratio"),
        ...
        <script type="application/ld+json">
            {
                ...
                "@type": "WebPage",
                "name": "<?php echo $insurerVertical; ?> Insurance Claim Settlement Ratio",
                "speakable":
                {
    ...
    <body <?php body_class('tm-style-1'); ?>>
        ...
        <div class="wp-site-blocks">
            ...
            <?php echo do_shortcode('[tm_ic_nh_banner type="claim-settlement"]'); ?>
