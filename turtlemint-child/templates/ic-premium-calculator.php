...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <?php
            ...
            $title = ucwords($insurerVertical)." Insurance Premium Calculator & Chart Online | Turtlemint";

            $description = "Calculate the premium for ".ucwords($insurerVertical)." Insurance policies online by entering a few details like your age, desired cover, and pincode.";

            $keywords = strtolower($insurerVertical)." insurance premium chart, ".strtolower($insurerVertical)." insurance premium calculator, ".strtolower($insurerVertical)." premium calculator, ".strtolower($insurerVertical)." insurance premium";
            ...
            $current_page_link = $term_page_link.'premium-calculator/';
            ...
            $piece["itemListElement"] = [
                ...
                [
                    "@type" => "ListItem",
                    "position" => 4,
                    "name" => ucwords($insurer_display_name." ".$vertical_name." Insurance Premium Calculator"),
        ...
        <script type="application/ld+json">
            {
                ...
                "@type": "WebPage",
                "name": "<?php echo $insurerVertical; ?> Insurance Premium Calculator",
                "speakable":
                {
    ...
    <body <?php body_class('tm-style-1'); ?>>
        ...
        <div class="wp-site-blocks">
            ...
            <?php echo do_shortcode('[tm_ic_nh_banner type="premium-calculator"]'); ?>
