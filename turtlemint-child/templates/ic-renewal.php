...
<html <?php language_attributes(); ?>>
    <head>
        ...
        <?php
            ...
            $title = ucwords($insurerVertical)." Insurance Policy Renewal | Turtlemint";

            $description = "Check the ".ucwords($insurerVertical)." Insurance renewal process and insurer customer care contact details online. Renew through Turtlemint for stress-free renewal experience.";

            $keywords = strtolower($insurerVertical)." renewal, ".strtolower($insurerVertical)." insurance renewal, ".strtolower($insurerVertical)." online renewal, ".strtolower($insurerVertical)." policy renewal, ".strtolower($insurerVertical)." instant renewal, instant renewal ".strtolower($insurerVertical).", renewal ".strtolower($insurerVertical).", ".strtolower($insurerVertical)." insurance online renewal, online renewal ".strtolower($insurerVertical)."";
            ...
            $current_page_link = $term_page_link.'renewal/';
            ...
            $piece["itemListElement"] = [
                ...
                [
                    "@type" => "ListItem",
                    "position" => 4,
                    "name" => ucwords($insurer_display_name." ".$vertical_name." Insurance Renewal"),
        ...
        <script type="application/ld+json">
            {
                ...
                "@type": "WebPage",
                "name": "<?php echo $insurerVertical; ?> Insurance Renewal",
                "speakable":
                {
    ...
    <body <?php body_class('tm-style-1'); ?>>
        ...
        <div class="wp-site-blocks">
            ...
            <?php echo do_shortcode('[tm_ic_nh_banner type="renewal"]'); ?>
