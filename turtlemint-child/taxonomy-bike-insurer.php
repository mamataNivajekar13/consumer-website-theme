...
$keywords = strtolower($insurerVertical)." insurance, ".strtolower($insurer_display_name)." two-wheeler insurance, ".strtolower($insurerVertical)." insurance plans, ".strtolower($insurerVertical)." insurance policy";
...
<?php wp_body_open(); ?>
    <div class="wp-site-blocks">
        ...
        <?php echo do_shortcode('[tm_ic_banner vertical="bike"]'); ?>
        ...
        <section class="wp-block-group has-global-padding is-layout-constrained">
            <div class="wp-block-columns alignwide is-layout-flex ic-two-column">
                <div class="wp-block-column is-layout-flow left-scrollable" style="flex-basis:65%">
                    ...
                    <?php echo do_shortcode('[tm_ic_plans vertical="bike"]'); ?>
                    <?php echo do_shortcode('[tm_ic_calculator vertical="bike"]'); ?>
                    <?php echo do_shortcode('[tm_ic_add_ons vertical="bike"]'); ?>
                    <?php echo do_shortcode('[tm_ic_features]'); ?>
                    <?php echo do_shortcode('[tm_ic_exclusions]'); ?>
                    <?php echo do_shortcode('[tm_ic_claim_process vertical="bike"]'); ?>
                    <?php echo do_shortcode('[tm_ic_documents]'); ?>
                    <?php echo do_shortcode('[tm_ic_customer_care]'); ?>
                    <?php echo do_shortcode('[tm_ic_renewal_process vertical="bike"]'); ?>
                    <?php echo do_shortcode('[tm_ic_buying_process vertical="bike"]'); ?>
